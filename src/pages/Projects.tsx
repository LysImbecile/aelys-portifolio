            ...
            <section className="md:h-full flex items-center text-gray-600">
                <div className="container px-5 py-14 mx-auto">
                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <Card img="https://i.ibb.co/bvNFNv8/image.png" date="January, 2024" link="https://github.com/henriquejustee/aelys-cv" title="My online resume" description="My online resume version, built with TailwindCSS and React, boasts a responsive and minimalistic design. Streamlined and focused, it showcases my qualifications and experience in a direct and impactful manner." />
                        {/* End of card */}
                    </div>
                </div>
            </section>
