            ...
            <section className="md:h-full flex items-center text-gray-600">
                <div className="container px-5 py-14 mx-auto">
                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <Card img="https://i.ibb.co/QmtTK28/image.png" date="January, 2024" link="https://github.com/henriquejustee/Discord_Lookup" title="Discord ID Lookup" description="This unofficial tool allows you to look up a Discord user or bot by their ID. It’s not affiliated with Discord itself. Simply input the user’s ID, and it will provide relevant information." />
