        ...
        <>
            <div className={"relative ml-auto mr-auto max-w-[80ch] scroll-smooth p-2 bg-black"} style={{ minHeight: 'calc(100vh - 1000px)'}}>
                <div className={"p-5 pt-10 flex flex-col justify-start "}>
                    ...
                    <p className="text-white pt-2 font-light">Ayo! My real name is <span className="text-red-600">[ confidential ]</span> and i'm a dude with <span className="text-red-600">1[ removed ]</span> years old. 
