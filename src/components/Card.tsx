        ...
        <>
            <div className="p-4 sm:w-1/2 lg:w-1/3">
                <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    <img className="lg:h-48 md:h-48 w-full object-cover object-center"
                        src={img} alt="blog" />
                    <div className="p-6 hover:bg-red-700 hover:text-white transition duration-300 ease-in">
                        ...
                        <p className="leading-relaxed text-white mb-3 line-clamp-3">{description}</p>
                        <div className="flex items-center flex-wrap ">
                            <a href={link} className="text-indigo-300 inline-flex items-center hover:text-white duration-300 cursor-pointer md:mb-2 lg:mb-0">Read More
